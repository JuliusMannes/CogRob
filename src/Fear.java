...
public Fear(float a_fFearDistance, float a_fClearDistance, UltraSonicSensor a_pLeftSensor, UltraSonicSensor a_pRightSensor) { 
	//Set variables
...
public boolean takeControl() {
	...
	if (!m_bInControl && (m_pLeftSensor.DetectSample() < m_fFearDistance || m_pRightSensor.DetectSample() < m_fFearDistance)) {
		//Log
		System.out.println("Object detected, initializing Fear!");
		return true;
	} 
	//Otherwise
	return false;
