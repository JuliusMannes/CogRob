...
public class MainRobot {
	public static void main(String[] args) {
		...
		UltraSonicSensor USS_Left = new UltraSonicSensor(SensorPort.S2, 1);
		
		Behavior b1 = new DriveForward();
		//Behavior b2 = new Fear(0.25f, 0.3f, USS_Left, USS_Right);
		//Behavior b2 = new Aggro(0.25f, 0.3f, USS_Left, USS_Right);
		Behavior b2 = new Love(0.25f, 0.3f, USS_Left, USS_Right, 500.0f);
