...
public class MainRobot {
	public static void main(String[] args) {
		...
		//Behavior b2 = new Love(0.1f, 0.3f, USS_Left, USS_Right, 1500.0f);
		//Behavior b2 = new Love(0.1f, 0.3f, USS_Right, USS_Left, 1500.0f); //Explore
		Behavior b2 = new Wanderer(0.1f, 0.3f, USS_Left, USS_Right, 1500.0f);
